...
def test_get_info_transaction(test_info_csv, test_info_xlsxx):
    ...
    assert info_xlsx[0] == test_info_xlsxx


def test_get_info_transactions_csv(test_info_csv, test_info_xlsxx):
    info_csv = get_info_transactions_csv("data/transactions.csv")
    assert info_csv[0] == test_info_csv
